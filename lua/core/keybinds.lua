...
-- fzf-lua
keymap('n', '<leader>ff', function() require('fzf-lua').files() end, { desc = 'Find File' })
keymap('n', '<leader>fr', function() require('fzf-lua').resume() end, { desc = 'Find Resume' })
keymap('n', '<leader>fg', function() require('fzf-lua').live_grep() end, { desc = 'Find String' })
keymap('n', '<leader>fk', function() require('fzf-lua').keymaps() end, { desc = 'Find Keymaps' })
keymap('n', '<leader>fh', function() require('fzf-lua').helptags() end, { desc = 'Find Help' })
keymap('n', '<leader>fC', function() require('fzf-lua').commands() end, { desc = 'Find Commands' })
keymap('n', '<leader>fd', function() require('fzf-lua').git_diff() end, { desc = 'Find Git Diff' })

-- kulala
keymap('n', '<leader>re', function() require('kulala').run() end, { desc = 'Execute request' })
keymap('n', '<leader>ra', function() require('kulala').run_all() end, { desc = 'Execute all requests' })
keymap('n', '<leader>rr', function() require('kulala').replay() end, { desc = 'Execute last request' })
keymap('n', '<leader>rt', function() require('kulala').show_stats() end, { desc = 'Show stats' })
keymap('n', '<leader>rp', function() require('kulala').scratchpad() end, { desc = 'Show scratchpad' })
keymap('n', '<leader>ri', function() require('kulala').inspect() end, { desc = 'Inspect' })
keymap('n', '<leader>rv', function() require('kulala').toggle_view() end, { desc = 'Toggle between body and headers' })
keymap('n', '<leader>rc', function() require('kulala').copy() end, { desc = 'Copy current request as a curl command' })
keymap('n', '<leader>rf', function() require('kulala').search() end, { desc = 'Search for http files' })
keymap('n', '<leader>rE', function() require('kulala').set_selected_env() end, { desc = 'Set selected environment' })
keymap('n', '<leader>rp', function() require('kulala').from_curl() end, { desc = 'Create request from curl' })
keymap('n', '[r', function() require('kulala').jump_prev() end, { desc = 'Previous request' })
keymap('n', ']r', function() require('kulala').jump_next() end, { desc = 'Next request' })
